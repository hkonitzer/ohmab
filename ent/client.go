...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		c.Address, c.AuditLog, c.Business, c.Content, c.Operator, c.Tag, c.Timetable,
		c.User,
	} {
		n.Use(hooks...)
	}
...
type (
	hooks struct {
		Address, AuditLog, Business, Content, Operator, Tag, Timetable, User []ent.Hook
	}
	inters struct {
		Address, AuditLog, Business, Content, Operator, Tag, Timetable,
